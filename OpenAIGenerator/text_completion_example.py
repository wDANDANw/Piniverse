...
def backtranslation(
...
) -> Union[str, List[Union[str, float]]]:
    """
    Generate a number of responses given a natural language instruction,
    ...
    :param additional_info: Additional information to include in the prompt
                            (Like SQL Tables, and their properties).
    :param instruction: The instruction in natural language.
    :param eval_template: The template to use for the evaluation.
    :param priming_prefix: The prefix to use for the priming of query.
    ...
    :return: The best  query, or a list of all scored generated SQL queries.
    """
