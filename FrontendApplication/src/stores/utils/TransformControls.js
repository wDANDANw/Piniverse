...
class TransformControls extends Object3D {
    ...
    constructor( _objects, camera, domElement ) {
        ...
        defineProperty( 'objects', _objects);
    ...
    pointerHover( pointer ) {
        ...
        _obj_intersections.length = 0;
        const obj_intersections = _raycaster.intersectObjects( this.objects, true, _obj_intersections );

        if ( obj_intersections.length > 0 ) {

            const object = obj_intersections[ 0 ].object;
    ...
    pointerDown( pointer ) {
        ...
        if ( this._hovered === null && this.object === undefined) return;
...
function onPointerHover( event ) {
    ...
    // TODO use pointer type to do actions
